...
for(i in 1:nproduction){
  par(mfrow=c(1,3))
  plot(ts_energy_data[,i],type="l",col="black",ylab="Production [Trillion Btu]",main="Energy Production")
  Acf(ts_energy_data[,i],lag.max=40,main=paste("Energy Production",i,sep="")) 
  Pacf(ts_energy_data[,i],lag.max=40,main=paste("Energy Production",i,sep=""))
}
...
detrend_Bioenergy_data <- df_energy_data[,2]-(Biobeta0+Biobeta1*t)
  ...
  ggplot(df_energy_data, aes(x=date, y=df_energy_data[,2])) +
            ...
            ylab(paste0(colnames(df_energy_data)[2],sep="")) +
            geom_smooth(color="red",method="lm") +
            geom_line(aes(y=detrend_energy_data), col="green")+
            geom_smooth(aes(y=detrend_energy_data),color="orange",method="lm")
##Renewable
...
```{r Q5}
    par(mfrow=c(1,3))
  plot(detrend_Bioenergy_data,type="l",col="black",ylab="Production [Trillion Btu]",main="Energy Production")
  ...
  Pacf(detrend_Bioenergy_data,lag.max=40,main=paste("Energy Production",i,sep=""))
    ...
    par(mfrow=c(1,3))
  plot(detrend_Renewenergy_data,type="l",col="black",ylab="Production [Trillion Btu]",main="Energy Production")
  ...
  Pacf(detrend_Renewenergy_data,lag.max=40,main=paste("Energy Production",i,sep=""))
    ...
    par(mfrow=c(1,3))
  plot(detrend_Hydroenergy_data,type="l",col="black",ylab="Production [Trillion Btu]",main="Energy Production")
  Acf(detrend_Hydroenergy_data,lag.max=40,main=paste("Energy Production",i,sep="")) 
  Pacf(detrend_Hydroenergy_data,lag.max=40,main=paste("Energy Production",i,sep=""))
...
```{r Q8}
par(mfrow=c(1,3))
  plot(Biodeseason_energy_data,type="l",col="black",ylab="Production [Trillion Btu]",main="Energy Production")
...
par(mfrow=c(1,3))
  plot(Renewdeseason_energy_data,type="l",col="black",ylab="Production [Trillion Btu]",main="Energy Production")
...
par(mfrow=c(1,3))
  plot(Hydrodeseason_energy_data,type="l",col="black",ylab="Production [Trillion Btu]",main="Energy Production")
  Acf(Hydrodeseason_energy_data,lag.max=40,main=paste("Energy Production",i,sep="")) 
  Pacf(Hydrodeseason_energy_data,lag.max=40,main=paste("Energy Production",i,sep=""))
